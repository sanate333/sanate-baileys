...
async function handleIncomingMessage(chatId, senderName, messageText, messageType, sendFn) {
  ...
  try {
    ...
    recordUsage();
    console.log('[auto-reply] Got reply via', provider, 'for', chatId, '- len:', reply.length, '| usage today:', getUsageStats().today);
...
module.exports = { handleIncomingMessage, getConfig, setConfig, getUsageStats };
